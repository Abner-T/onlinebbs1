...
%>
  ...
  <div class="layui-col-md6">
    <div class="layui-panel">
      ...
      <span style="color:#f90">用户名:</span>&nbsp;<%=rs.getString("name") %><br><br>
  	  <span style="color:#f90">题目:</span>&nbsp;<%=rs.getString("title") %><br><br>
      <span style="color:#f90">留言内容:</span>&nbsp;<%=rs.getString("description") %><br><br>
      <a href="updatemessage.jsp?id=<%=rs.getString("id")%>">修改</a><br><br>
      </div>
    </div>   
  </div>
